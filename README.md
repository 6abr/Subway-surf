...
5. Go back again to files folder and remove everything from characters_inventory.json and paste whats in the [characters_invetory.txt](characters_inventory.txt) _and save it!_ ( Now you get all the skins)
